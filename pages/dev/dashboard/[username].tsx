...
export default function DevDashboard({ user: initialUser, links: initialLinks }: DevDashboardProps) {
    ...
    try {
      const response = await fetch('/api/links', {
        ...
        headers: {
          ...
          'x-user-address': 'dev-mode',
        },
        body: JSON.stringify({ address: 'dev-mode', userId: initialUser.id }),
      });
      if (response.ok) {
  ...
  const handleAddLink = async () => {
    ...
    try {
      const response = await fetch("/api/links", {
        ...
        body: JSON.stringify({ ...newLink, address: "dev-mode", userId: initialUser.id }),
      });
  ...
  const handleUpdateUsername = async () => {
    ...
    try {
      const response = await fetch("/api/user/username", {
        ...
        body: JSON.stringify({ username, address: "dev-mode", userId: initialUser.id }),
      })
  ...
  const handleUpdateBio = async () => {
    ...
    try {
      const response = await fetch("/api/profile", {
        ...
        body: JSON.stringify({ bio, address: "dev-mode", userId: initialUser.id }),
      });
      ...
      reader.onloadend = async () => {
        ...
        try {
          ...
          const uploadResponse = await fetch('/api/upload/avatar', {
            ...
            body: JSON.stringify({ imageData: base64data, userId: initialUser.id }),
          });
          ...
          const updateResponse = await fetch('/api/profile', {
            ...
            body: JSON.stringify({ avatar: avatarUrl, userId: initialUser.id }),
          });
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-yellow-100 dark:bg-yellow-900 border-2 border-yellow-400 dark:border-yellow-600 rounded-lg p-4 mb-6">
            <p className="text-yellow-800 dark:text-yellow-200 text-sm font-semibold">
              ⚠️ DEV MODE: Accessing dashboard for @{initialUser.username} without authentication
            </p>
          </div>

          <div className="mb-8 flex justify-between items-center">
            <h1 className="text-4xl font-bold">Dashboard (Dev Mode)</h1>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4">
                <div className="relative">
                  <img
                    src={avatarPreview || initialUser.avatar || '/img/logo-128x128.png'}
                    alt="Profile"
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <button
                  ...
                  disabled={isSavingUsername || username.length < 5 || username === initialUser.username}
              ...
              {initialUser.username && (
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Current profile: <a href={`/${initialUser.username}`} target="_blank" className="text-blue-600 hover:underline">{getDomain()}/{initialUser.username}</a>
                  {username !== initialUser.username && username.length >= 5 && (
